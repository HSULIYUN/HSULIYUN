...
全端工程師，結合 AI 應用開發。把專案從資料庫、後端邏輯、前端畫面到部署都跑完，也喜歡把 AI 能力（電腦視覺、LLM）實際整合進產品裡。
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,js,java,html,css&theme=dark&perline=6" />
</p>
